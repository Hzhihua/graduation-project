...
/**
 * Class m180113_135524_0_table_comment
 * @property \yii\db\Transaction $_transaction
 * @Author Hzhihua <cnzhihua@gmail.com>
 */
class m180113_135524_0_table_comment extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->runSuccess['createTable'] = $this->createTable('{{%comment}}', [
            'id' => $this->bigInteger(10)->unsigned()->notNull(),
            ...
            'status' => $this->smallInteger(3)->unsigned()->notNull()->comment('评论状态'),
