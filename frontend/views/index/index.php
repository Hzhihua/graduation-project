...
<ul class="post-list">
    ...
    <li class="post-list-item fade in">
        <article id="post-binarySearch/index" class="article-card article-type-post" itemprop="blogPost">
            ...
            <div class="post-content" id="post-content" itemprop="postContent">
                ...
                二分查找法假设你要在电话簿中查找一个以K开头的名字（现在谁还用电话簿！），可以从头开始翻页，一直翻到以K开头的部分。但是你应该不会这样做，而是直接从中间开始查找，因为你知道以K开头的名字在电话簿中间。
